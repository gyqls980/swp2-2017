...
from keypad2_rom import numPadList, operatorList, constantList, functionList
import calcFunctions_rom
...
class Calculator(QWidget):
    ...
    def buttonClicked(self):
        ...
        funclist = ['factorial', 'decToBin', 'binToDec', 'decToRoman', 'romanToDec']
        ...
        if key == '=':
            ...
            n = self.display.text()
            value = getattr(calcFunctions_rom, funclist[index])
